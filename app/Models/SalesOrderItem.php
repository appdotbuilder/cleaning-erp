 ...
 * @method static \Illuminate\Database\Eloquent\Builder|SalesOrderItem whereFinishedGoodId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|SalesOrderItem whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|SalesOrderItem whereNotes($value)
...
class SalesOrderItem extends Model
{
    ...
    /**
     * Get the finished good that owns the item.
     */
